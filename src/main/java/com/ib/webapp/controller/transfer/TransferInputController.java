 ...
 */
@Controller
@RequestMapping("/transfer/transferInput*")
public class TransferInputController extends BaseFormController {

    private Transfer transfer;
    private Map<String,String> accountNumberList;

    public TransferInputController() {
        setCancelView("redirect:/home");
        setSuccessView("/transfer/transferConfirm");
    }
