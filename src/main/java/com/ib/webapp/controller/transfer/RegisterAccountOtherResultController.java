 ...
 */
@Controller
@RequestMapping("/registerAccountOtherResult*")
public class RegisterAccountOtherResultController extends BaseFormController {

    public RegisterAccountOtherResultController() {
