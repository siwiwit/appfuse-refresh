 ...
 */
@Controller
@RequestMapping("/transfer/transferResult*")
public class TransferResultController extends BaseFormController {

    public TransferResultController() {
        setCancelView("/transfer/transferConfirm");
