...
<div class="col-sm-7">
    ...
    <form:form commandName="transfer" method="post" action="registerAccountOtherInput" id="transferForm" >

    <div class="row">
        <div class="col-sm-6 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
            <spring:bind path="transfer.destinationBankCode">
                <appfuse:label styleClass="control-label" key="transfer.destinationBankCode"/>
                <br />
                <form:select path="destinationBankCode" >
