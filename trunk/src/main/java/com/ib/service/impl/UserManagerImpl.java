...
import com.ib.dao.UserDao;
import com.ib.model.User;
import com.ib.service.MailEngine;
import com.ib.service.UserExistsException;
import com.ib.service.UserManager;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.ib.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.ib.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
