...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.ib.service.impl.PasswordTokenManager#generateRecoveryToken(com.ib.model.User)
     */
    @Override
    ...
    /**
     * @see com.ib.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.ib.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.ib.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
