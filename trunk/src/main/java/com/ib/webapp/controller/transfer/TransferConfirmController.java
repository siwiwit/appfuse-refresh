 ...
 */
@Controller
@RequestMapping("/transfer/transferConfirm*")
public class TransferConfirmController extends BaseFormController {
    ...
    public TransferConfirmController() {
        setCancelView("/transfer/transferInput");
        setSuccessView("/transfer/transferResult");
    }
